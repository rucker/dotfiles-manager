...
def handleBashrcFileWrite(inputFile, contents):
  ...
  with io.StringIO() as bashrc:
    for line in inputFile:
      if line.startswith('#'):
        ...
        bashrc.write(unicode(line))
    handleBashrcFileWrite(inputFile, bashrc)
